import orden1 from '../assets/images/bubble8.png';
import orden2 from '../assets/images/bubble9.png';
    ...
    return (
        <section className="flex flex-col md:flex-row w-full font-raleway">
            ...
            <div className="flex flex-col items-center md:justify-end md:items-end">
                <img src={orden1} class="w-1/2 md:w-full lg:w-4/5 md:pr-5 pt-6 md:pt-20" alt=""/>
            </div>
        </div>
        <div className="bg-[#e0de90] flex flex-col md:flex-row w-full md:w-1/2">
            ...
            <div className="flex flex-col items-center md:justify-end md:items-end">
                <img src={orden2} class="w-1/2 md:w-full lg:w-4/5 md:pr-5 pt-6 md:pt-20" alt=""/>
            </div>
        </div>
        </section>
    )
